...
This module is used to provide a proprietary coprocessor service allowing to use a serial connection to communicate with the Arm® Cortex®-M processor embedded.
...
This module contains several Java files implementing the service.
